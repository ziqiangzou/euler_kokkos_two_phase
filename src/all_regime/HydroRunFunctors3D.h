...
namespace euler_kokkos { namespace all_regime
	{
		...
		class ComputeTransportStepFunctor3D : HydroBaseFunctor3D
		{
			public:
				ComputeTransportStepFunctor3D(HydroParams params_,
						DataArrayConst Udata_, DataArrayConst Qdata_, DataArray U2data_, DataArrayConst gradphi_,
						real_t dt_) :
				...
				static void apply(HydroParams params,
						DataArrayConst Udata, DataArrayConst Qdata, DataArray U2data, DataArrayConst gradphi,
						real_t dt, int nbCells)
				{
					ComputeTransportStepFunctor3D functor(params, Udata, Qdata, U2data, gradphi, dt);
					Kokkos::parallel_for(nbCells, functor);
				}
		...
		class CopyGradientFunctor3D : HydroBaseFunctor3D
		{
			public:
				...
				const int KY;
				const DataArray gradphi;
		}; // ComputeGradientUVFunctor3D
		class ComputeExtraUVFunctor3D : HydroBaseFunctor3D
		{
			public:
				ComputeExtraUVFunctor3D(HydroParams params_,
				...
				static void apply(HydroParams params,
						DataArrayConst Qdata, DataArray Q0data, DataArray Udata, DataArray gradphi,
						 int nbCells)
				{
					ComputeExtraUVFunctor3D functor(params, Qdata, Q0data, Udata, gradphi);
					Kokkos::parallel_for(nbCells, functor);
				}
				...
				const DataArray Udata;
				const DataArray gradphi;
		}; // ComputeGradientFunctor3D

		class ComputeExtraGradientUVFunctor3D : HydroBaseFunctor3D
		{
			public:
				ComputeExtraGradientUVFunctor3D(HydroParams params_,
				...
				static void apply(HydroParams params,
						...
						int nbCells)
				{
					ComputeExtraGradientUVFunctor3D functor(params, Qdata, Udata, gradphi);
					Kokkos::parallel_for(nbCells, functor);
				}
		...
		class ComputeGradientUVFunctor3D : HydroBaseFunctor3D
		{
			public:
				ComputeGradientUVFunctor3D(HydroParams params_,
						DataArrayConst Qdata_, DataArray Q0data_, DataArray Udata_, DataArray gradphi_) :
					HydroBaseFunctor3D(params_),
					Qdata(Qdata_), Q0data(Q0data_), Udata(Udata_), gradphi(gradphi_) {};
				...
				static void apply(HydroParams params,
						DataArrayConst Qdata, DataArray Q0data, DataArray Udata, DataArray gradphi,
						 int nbCells)
				{
					ComputeGradientUVFunctor3D functor(params, Qdata, Q0data, Udata, gradphi);
					Kokkos::parallel_for(nbCells, functor);
				}
