...
struct LevelSetFunctors<2>
{
    ...
    using RedistancingPhiHopfLax = ComputeRedistancingPhiHopfLaxFunctor2D;
    ...
    using ComputeCurvatureHF    = ComputeCurvatureHFFunctor2D;
};
template<>
struct LevelSetFunctors<3>
{
    ...
    using RedistancingPhiHopfLax = ComputeRedistancingPhiHopfLaxFunctor3D;
    ...
    using ComputeCurvatureHF    = ComputeCurvatureHFFunctor3D;
