...
struct RunFunctors<2>
{
    ...
    using ExtraGradientUV     = ComputeExtraGradientUVFunctor2D;
    using ExtraUV             = ComputeExtraUVFunctor2D;
    using ComputeGradientUV   = ComputeGradientUVFunctor2D;
...
struct RunFunctors<3>
{
    ...
    using ExtraGradientUV     = ComputeExtraGradientUVFunctor3D;
    using ExtraUV             = ComputeExtraUVFunctor3D;
    using ComputeGradientUV   = ComputeGradientUVFunctor3D;
